...
function SendSol() {
  ...
  async function unwrapSol() {
    ...
    await closeAccount(connection, fromWallet, associatedTokenAccount, fromWallet.publicKey, fromWallet);
  ...
  async function sendSol() {
    ...
    const toWallet = new PublicKey("67vBfC1hMbTLhEeH5yZd5N7ADELXF9w15J7CHopGSquK");
